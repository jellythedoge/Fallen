...
namespace Overlay
{
    public class Direct2DRenderer
    {
        ...
        private void SetupInstance(bool deleteOld = false)
        {
            ...
            SDK.GetWindowRect(TargetHandle, out RECT bounds);
        ...
        public void BeginScene()
        {
            ...
            if (SDK.PeekMessage(out MSG msg, IntPtr.Zero, 0, 0, 1) != 0) {
                SDK.TranslateMessage(ref msg);
                SDK.DispatchMessage(ref msg);
            }
        ...
        public void EndScene()
        {
            ...
            var result = _device.TryEndDraw(out long tag_1, out long tag_2);
